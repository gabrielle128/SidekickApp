...
public class UpcomingAdapter extends RecyclerView.Adapter<UpcomingAdapter.ViewHolder>{
    ...
    private final List<Model> myUpcomingList;
    ...
    public UpcomingAdapter(Context mContext, List<Model> myUpcomingList) {
        this.mContext = mContext;
        this.myUpcomingList = myUpcomingList;
    }
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        final Model model = myUpcomingList.get(position);
        ...
        upcoming.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                holder.todoCard.setCardBackgroundColor(Color.parseColor("#8cd3a9"));
            }
