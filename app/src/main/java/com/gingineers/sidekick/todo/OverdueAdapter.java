...
public class OverdueAdapter extends RecyclerView.Adapter<OverdueAdapter.ViewHolder>{
    ...
    private final List<Model> myOverdueList;
    ...
    public OverdueAdapter(Context mContext, List<Model> myOverdueList) {
        this.mContext = mContext;
        this.myOverdueList = myOverdueList;
    }
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        final Model model = myOverdueList.get(position);
        ...
        overdue.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                holder.todoCard.setCardBackgroundColor(Color.parseColor("#ef949d"));
            }
